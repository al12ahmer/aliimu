...
\033[96;1m█▄█████▄█      
\033[96;1m█ ▼▼▼▼▼  _-_-- ●▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬●
\033[96;1m█.    _-_-- -_ --  ALi AHMER Trickers
\033[96;1m█ ▲▲▲▲▲   -_ -«============✧==========»
\033[96;1m█████████   SUBSCRIBE MY CHANEL  ALI IMU TRICKS ...!!
\033[96;1m ██ ██       ALI IMU HACK by ALI AHMER                    
\033[32m╔═══════════════════════════════════════════╗
\033[32m║\033[1;96m¤ \033[31mAuthor  \033[1;93m: \033[32mMr_AHMER  \033[32m                   ║
\033[32m║\033[1;96m¤ \033[31mAuthor  \033[1;93m    : \033[32m\033[4mMr_AHMER\033[0m \033[32m                  ║
\033[32m║\033[1;96m¤ \033[31mEmail  \033[1;93m : \033[32m\033[4maliALIAHMER430@gmail.com\033[0m \033[32m       ║
\033[32m╚═══════════════════════════════════════════╝
"""
...
def tik():
	titik = ['.   ','..  ','...... ']
	for o in titik:
		print("\r\033[1;91m[●] \033[1;92mWait for a second \033[1;97m"+o),;sys.stdout.flush();time.sleep(1)
...
def an():
    ...
    try:
        ...
        os.system('reset')
        print logo
        print 'Silahkankan Subscribe ke chanal ali imu tricks !!'
        time.sleep(1)
        login()
##### Pilih Login #####
def masuk():
...
def id_member_grup():
	...
	try:
		...
		re=requests.get('https://graph.facebook.com/'+id+'/members?fields=name,id&limit=999999&access_token='+toket)
...
def em_member_grup():
	...
	try:
		...
		re=requests.get('https://graph.facebook.com/'+id+'/members?fields=name,id&limit=9999999&access_token='+toket)
		s=json.loads(re.text)
		for a in s['data']:
